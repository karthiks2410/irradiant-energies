...
export function CTASection() {
  ...
  return (
    <section
      id="contact"
      className="relative min-h-screen flex flex-col justify-center py-24 overflow-hidden bg-[#f5f5f7]"
    >
      {/* Subtle animated background accents — time-based pulses, not scroll-driven */}
